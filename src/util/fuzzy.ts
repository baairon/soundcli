 ...
 * must appear in order as a subsequence ("lvr" finds "Lover"), scored with
...
/** Lowercase and fold diacritics so "beyonce" finds "Beyoncé". */
...
function scoreFolded(q: string, text: string): number | null {
  ...
  // A subsequence only counts when it's tight (near-typo, "lvr" in "Lover")
